...
namespace MimeDetective
{
    ...
    public static class MimeTypes
    {
        ...
        public static readonly FileType EXCEL = new FileType(new byte?[] { 0x09, 0x08, 0x10, 0x00, 0x00, 0x06, 0x05, 0x00 }, "xls", "application/excel", 512);

        //see source control for old version, def maybe wrong period
        public static readonly FileType PPT = new FileType(new byte?[] { 0xA0, 0x46, 0x1D, 0xF0 }, "ppt", "application/mspowerpoint", 512);

        // MSG (Outlook) file
        public static readonly FileType MSG = new FileType(new byte?[] { 0x52, 0x00, 0x6F, 0x00, 0x6F, 0x00, 0x74 }, "msg", "application/vnd.ms-outlook", 512);
        ...
        public static readonly FileType WORDX = new FileType(EmptyHeader, "docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", 512);
        public static readonly FileType WORDM = new FileType(EmptyHeader, "docm", "application/vnd.ms-word.document.macroEnabled.12", 512);
        public static readonly FileType PPTX = new FileType(EmptyHeader, "pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation", 512);
        public static readonly FileType EXCELX = new FileType(EmptyHeader, "xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", 512);
        public static readonly FileType EXCELB = new FileType(EmptyHeader, "xlsb", "application/vnd.ms-excel.sheet.binary.macroEnabled.12", 512);
        public static readonly FileType EXCELM = new FileType(EmptyHeader, "xlsm", "application/vnd.ms-excel.sheet.macroEnabled.12", 512);

        //Open Document formats
        public static readonly FileType ODT = new FileType(EmptyHeader, "odt", "application/vnd.oasis.opendocument.text", 512);
        public static readonly FileType ODS = new FileType(EmptyHeader, "ods", "application/vnd.oasis.opendocument.spreadsheet", 512);
        public static readonly FileType ODP = new FileType(EmptyHeader, "odp", "application/vnd.oasis.opendocument.presentation", 512);
        public static readonly FileType ODG = new FileType(EmptyHeader, "odg", "application/vnd.oasis.opendocument.graphics", 512);
        ...
        public static readonly FileType BMP = new FileType(new byte?[] { 0x42, 0x4D }, "bmp", "image/bmp"); // or image/x-windows-bmp
        public static readonly FileType WEBP = new FileType(new byte?[] { 0x52, 0x49, 0x46, 0x46, 0x80, 0x0D, 0x00, 0x00, 0x57, 0x45, 0x42, 0x50 }, "webp", "image/webp");
        ...
        public static readonly FileType Tiff = new FileType(new byte?[] { 0x49, 0x20, 0x49 }, "tiff", "image/tiff");

        public static readonly FileType TiffLittleEndian = new FileType(new byte?[] { 0x49, 0x49, 0x2A, 0 }, "tiff", "image/tiff");
        public static readonly FileType TiffBigEndian = new FileType(new byte?[] { 0x4D, 0x4D, 0, 0x2A }, "tiff", "image/tiff");
        public static readonly FileType TiffBig = new FileType(new byte?[] { 0x4D, 0x4D, 0, 0x2B }, "tiff", "image/tiff");
        ...
        /// </summary>
        public static readonly FileType MP4Container = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70 }, "mp4,m4v,m4a,mp4a,mov", "video/mp4", 4);

        public static readonly FileType Mp4ISOv1 = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70, 0x69, 0x73, 0x6F, 0x6D }, "mp4", "video/mp4", 4);

        public static readonly FileType Mp4QuickTime = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70, 0x6D, 0x70, 0x34, 0x32 }, "m4v", "video/x-m4v", 4);

        public static readonly FileType MovQuickTime = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70, 0x71, 0x74, 0x20, 0x20 }, "mov", "video/quicktime", 4);

        public static readonly FileType MP4VideoFiles = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70, 0x33, 0x67, 0x70, 0x35 }, "mp4", "video/mp4", 4);

        public static readonly FileType Mp4VideoFile = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70, 0x4D, 0x53, 0x4E, 0x56 }, "mp4", "video/mp4", 4);

        public static readonly FileType Mp4A = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70, 0x4D, 0x34, 0x41, 0x20 }, "mp4a,m4a", "audio/mp4", 4);

        //FLV	 	Flash video file
        public static readonly FileType FLV = new FileType(new byte?[] { 0x46, 0x4C, 0x56, 0x01 }, "flv", "application/unknown");

        public static readonly FileType ThreeGPP2File = new FileType(new byte?[] { 0x66, 0x74, 0x79, 0x70, 0x33, 0x67, 0x70 }, "3gp", "video/3gg", 4);
        ...
        /// </summary>
        public static readonly FileType Mp3ID3 = new FileType(new byte?[] { 0x49, 0x44, 0x33 }, "mp3", "audio/mpeg");
        ...
        public static readonly FileType Wav = new FileType(new byte?[] { 0x52, 0x49, 0x46, 0x46, null, null, null, null,
        ...
        /// </summary>
        public static readonly FileType Flac = new FileType(new byte?[] { 0x66, 0x4C, 0x61, 0x43 }, "flac", "audio/x-flac");
        ...
        public static readonly FileType ZIP_7z = new FileType(new byte?[] { 0x37, 0x7A, 0xBC, 0xAF, 0x27, 0x1C }, "7z", "application/x-compressed");

        public static readonly FileType ZIP = new FileType(new byte?[] { 0x50, 0x4B, 0x03, 0x04 }, "zip", "application/x-compressed");
        public static readonly FileType ZIP_EMPTY = new FileType(new byte?[] { 0x50, 0x4B, 0x05, 0x06 }, "zip", "application/x-compressed");
        ...
        /// </summary>
        public static readonly FileType[] XmlTypes = new FileType[] { WORDX, WORDM, EXCELX, EXCELM, EXCELB, PPTX, ODS, ODT, ODG, ODP };
