...
{
    public class DictionaryBased2TrieTests
    {
        [Fact]
        public void DefaultConstructor()
        {
            var analyzer = new DictionaryBasedTrie2();
        ...
        {
            var analyzer = new DictionaryBasedTrie2(MimeTypes.Types);

            //assertion here just to have
            Assert.NotNull(analyzer);

            Assert.Throws<ArgumentNullException>(() => new DictionaryBasedTrie2(null));
